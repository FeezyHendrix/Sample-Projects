...
total = 0 
for x in result:
	if x in "AEIOUaeiou": # Python allows for the iteration of strings using the word 'in'.
...
if total > 1: # In order to print correct grammer, prints a sentence based on the number of vowels.
	print "There were %s vowels found." % total
else:
	print "There was %s vowel found." % total
